...
<section class="py-5" style="background: linear-gradient(135deg, #440710 0%, #751423 50%, #2a050b 100%); color: #fff;">
    <div class="container text-center py-4">
        <span class="hero-crest-badge">
            <i class="bi bi-shield-check text-gold"></i> বিশ্বাসের বন্ধনে, সুন্দর আগামী
        </span>
        <h1 class="display-5 font-serif fw-bold text-white mb-3">About Biye Marriage Media</h1>
        <p class="fs-5 text-white-50 mx-auto" style="max-width: 760px;">
            Professional bride and groom matching in Bangladesh and overseas. We prioritize Islamic values and family compatibility to help you find your ideal life partner.
        </p>
    </div>
</section>
...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <span class="section-tag">About Biye Marriage Media</span>
                <h2 class="section-title">Built on Trust, Islamic Values & Deep Family Compatibility</h2>
                <p class="text-secondary leading-relaxed mb-4">
                    At <strong>Biye Marriage Media</strong>, we believe that a successful marriage is built on trust, Islamic values, and deep family compatibility. We operate as professional marriage consultants dedicated to providing a safe, secure, and 100% confidential platform for bride and groom matching.
                </p>
                <p class="text-secondary leading-relaxed mb-4">
                ...
                <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 start-0 end-0 p-4 bg-dark bg-opacity-75 text-white rounded-bottom-4">
                        <p class="fst-italic mb-0 small">
                            "বিশ্বাসের বন্ধনে, সুন্দর আগামী — Dedicated to creating blessed, honorable, and lifelong marital unions."
                        </p>
                    </div>
                </div>
            </div>
...
<section class="section-padding bg-soft">
    <div class="container">
        <div class="section-header">
            ...
            <h2 class="section-title">The Cornerstones of Our Service</h2>
            <p class="section-desc">
                Every member experiences our three unshakeable commitments to prestige and privacy.
            </p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="pillar-card text-center p-4">
                    ...
                    <h4 class="pillar-title">Uncompromising Discretion</h4>
                    <p class="pillar-desc">
                        Your identity, photographs, and family credentials are never displayed publicly. Information is shared only upon bilateral consent between both prospective families.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="pillar-card text-center p-4">
                    ...
                    <h4 class="pillar-title">In-Person Relationship Care</h4>
                    <p class="pillar-desc">
                        Our seasoned Relationship Managers come from your region, appreciate cultural nuances, visit your residence, and coordinate all prospective communications.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="pillar-card text-center p-4">
                    ...
                    <h4 class="pillar-title">Rigorous Vetting Process</h4>
                    <p class="pillar-desc">
                        Every profile undergoes deep verification covering educational degrees (BUET/IBA/DMC/Abroad), financial assets/income, corporate standing, and family reputation.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-lg-2">
                <span class="section-tag">Personalized Concierge</span>
                <h2 class="section-title">Your Private Matchmaker & Family Confidant</h2>
                <p class="text-secondary leading-relaxed mb-4">
                    Finding the right life partner is a deeply personal and family-centered journey. Our matchmakers act as private advisors:
                </p>
                <ul class="list-unstyled mb-4">
                    <li class="d-flex align-items-start gap-3 mb-3">
                        <i class="bi bi-check-circle-fill text-maroon fs-5 mt-1"></i>
                        <div>
                            <strong>In-Home Consultations:</strong> We meet your family at your residence in Gulshan, Banani, Baridhara, Dhanmondi, DOHS, or Khulshi to understand preferences, traditions, and lifestyle expectations.
                        </div>
                    </li>
                    <li class="d-flex align-items-start gap-3 mb-3">
                        <i class="bi bi-check-circle-fill text-maroon fs-5 mt-1"></i>
                        <div>
                            <strong>Weekly Curated Portfolios:</strong> Receive handpicked, thoroughly screened executive briefs tailored to your specific criteria.
                        </div>
                    </li>
                    <li class="d-flex align-items-start gap-3 mb-3">
                        <i class="bi bi-check-circle-fill text-maroon fs-5 mt-1"></i>
                        <div>
                            <strong>Bespoke Meeting Coordination:</strong> We facilitate respectful, confidential interactions in premier five-star venues (Radisson, Westin, InterContinental) or private family lounges.
                        </div>
                    </li>
                </ul>
